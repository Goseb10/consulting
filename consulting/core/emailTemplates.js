...
export const emailTemplates = {
    ...
    ep: (t, data, formatMonetaire) => `
        ...
        <p>
            ...
            ${t('email_ep_yield_text')}: Entre 5,00% et 10,00%. <a href="https://www.wikifin.be/fr/epargner-et-investir/produits-dinvestissement/produits-dassurances/assurance-de-la-branche-23/quest" target="_blank" rel="noopener noreferrer">${t('email_ep_yield_source')}</a>.<br>
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
    ...
    elt: (t, data, formatMonetaire) => `
        ...
        <p>
            ...
            ${t('email_ep_yield_text')}: Entre 5,00% et 10,00%. <a href="https://www.google.com" target="_blank" rel="noopener noreferrer">${t('email_elt_yield_source')}</a>.<br>
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
